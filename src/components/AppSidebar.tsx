...
const menuItems = [
  ...
  { title: 'MSME Credit Report', url: '/msme-credit-report', icon: CreditCard },
  {
    ...
    subItems: [
      ...
      { title: 'Manage Orders', url: '/sawmill/manage-orders', icon: FileText },
      { title: 'Machines', url: '/sawmill/machines', icon: Wrench },
      { title: 'Dispatch', url: '/sawmill/dispatch', icon: Truck },
      { title: 'Reports', url: '/sawmill/reports', icon: BarChart3 },
      { title: 'User Management', url: '/sawmill/users', icon: Users },
    ],
  },
  {
    title: 'Masters',
